#!/usr/bin/env python3
"""
AGY Interactive CLI - Original Interface
==========================================
...
# Version info
__version__ = "1.1.27"
__model__ = "Claude Opus 4.6 (Thinking)"
__user__ = "developerlckz@gmail.com"
__quota__ = "Antigravity Starter Quota"

# Rainbow arch logo (matching original AGY interface)
LOGO = """
                    ░▀▄▀█▀▄░█▀█░█▀▀░█▀█░█▀▄░█▀█░█▀▀░
                    ░█░█░█░█░█▀▀░█▀▀░█░█░█▀▄░█▀▀░
                    ░▀░▀▀▀▀▀░▀░░░▀░░░▀░▀░▀░▀░▀░░░
...
class AGYInteractive:
    ...
    def print_header(self):
        ...
        print(LOGO)
        print()
        print(f"  Antigravity CLI {__version__}")
        print(f"  {_user__} ({__quota__})")
        print(f"  {_model__}")
        print()
        print("  " + "-" * 60)
        print()
